<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/cms/index">FUTURE GOALS</a>
            </div>
                ...
                ?>
                    ...
                    if(isset($_SESSION['user_role'])){
                        if(isset($_GET['p_id'])){
                            ...
                            echo "<li><a href='/cms/admin/posts.php?source=edit_post&p_id={$the_post_id}'>Edit page</a></li>";
                        }
                    } 
                    ?> 
                </ul>
