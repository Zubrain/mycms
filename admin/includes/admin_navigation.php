<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li>
                    <!-- <a href="#"><b>Users Online:</b> <?php// echo users_online(); ?></a> -->
                    <a href="#"><b>Users Online:</b><span class="usersonline"></span></a>
                </li>
                 <li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#post_dropdown"><i class="fa fa-fw fa-file-text"></i> Posts <i class="fa fa-fw fa-caret-down"></i></a>
