            ...
            <a href="categories.php">
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        ...
                        $element_text = ['Active Post', 'Approved Comment', 'Draft Post', 'Comments', 'Users', 'Categories'];
                        $element_count = [$post_count, $approved_comment_count, $post_draft_count, $comment_count, $user_count, $category_count];
